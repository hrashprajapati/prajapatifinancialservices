...
<meta name="keywords" content="financial advisor Sagar, mutual fund distributor Madhya Pradesh, retirement planning, portfolio management, NISM certified advisor, goal based investing, Harsh Prajapati">
<meta name="robots" content="index, follow">
<link rel="canonical" href="https://prajapatifinancialservices.com/">
<meta name="theme-color" content="#0A2540">

<!-- Open Graph -->
<meta property="og:type" content="website">
<meta property="og:title" content="Prajapati Investment & Financial Services — Wealth Planning, Sagar MP">
<meta property="og:description" content="Personalized financial planning, mutual fund distribution, retirement planning and goal-based investing with Harsh Prajapati, Sagar, Madhya Pradesh.">
<meta property="og:url" content="https://prajapatifinancialservices.com/">
<meta property="og:site_name" content="Prajapati Investment & Financial Services">
<meta property="og:locale" content="en_IN">

<!-- Twitter -->
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="Prajapati Investment & Financial Services">
<meta name="twitter:description" content="Personalized financial planning, mutual fund distribution, retirement planning and goal-based investing in Sagar, Madhya Pradesh.">

<!-- Favicon: navy circle with gold PF monogram -->
<link rel="icon" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'%3E%3Ccircle cx='32' cy='32' r='32' fill='%230A2540'/%3E%3Ctext x='32' y='42' font-family='Georgia,serif' font-size='26' font-weight='600' fill='%23D4AF37' text-anchor='middle'%3EP%3C/text%3E%3C/svg%3E">
...
<script type="application/ld+json">
{
  ...
  "name": "Prajapati Investment & Financial Services",
  "url": "https://prajapatifinancialservices.com/",
  "telephone": "+91-62642-00751",
  "email": "hrashprajapati99@gmail.com",
  "founder": {
    "@type": "Person",
  ...
  "address": {
    "@type": "PostalAddress",
    "streetAddress": "Shop No. 6, Second Floor, Above Anand Store, Gadaji Complex, Gujarati Bazar",
    "addressLocality": "Sagar",
    "addressRegion": "Madhya Pradesh",
    "addressCountry": "IN"
  },
  "areaServed": "Sagar, Madhya Pradesh",
  "sameAs": [
    "https://linkedin.com/in/hrash-prajapati-7262512b2"
  ],
  "priceRange": "$$"
}
</script>
...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  .hero::before{
    content:'';position:absolute;top:-10%;right:-5%;width:520px;height:520px;
  ...
  .goal-card:hover{background:#fff;transform:translateY(-5px);box-shadow:0 16px 32px rgba(10,37,64,0.1);z-index:1;}
  ...
  /* Offerings (core services / planning / sequence) */
  .offer-block{margin-bottom:48px;}
  .offer-block:last-child{margin-bottom:0;}
  .offer-block h3{font-size:1.15rem;margin-bottom:20px;}
  .offer-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:20px;}
  .mini-steps{display:grid;grid-template-columns:repeat(4,1fr);gap:24px;}
  .mini-step-num{
    width:36px;height:36px;border-radius:50%;
    border:1px solid var(--gold);color:var(--navy);background:#fff;
    display:flex;align-items:center;justify-content:center;
    font-family:'IBM Plex Mono',monospace;font-size:0.78rem;margin-bottom:14px;
  }
  .mini-step h4{font-size:0.95rem;margin-bottom:6px;font-family:'Fraunces',serif;font-weight:600;}
  .mini-step p{font-size:0.85rem;color:var(--muted);}
  ...
  .why-item{background:#fff;padding:26px 22px;display:flex;gap:12px;align-items:flex-start;transition:transform 0.25s ease, box-shadow 0.25s ease;}
  .why-item:hover{transform:translateY(-3px);box-shadow:0 10px 24px rgba(10,37,64,0.08);position:relative;z-index:1;}
  ...
  .calc-card:hover{transform:translateY(-5px);box-shadow:0 16px 32px rgba(6,24,41,0.35);border-color:var(--gold);}
  ...
  .gform-embed{border-radius:var(--radius);overflow:hidden;border:1px solid var(--line);}
  .gform-embed iframe{width:100%;height:820px;border:0;display:block;}
  ...
  @media (max-width:860px){
    ...
    .facts-strip{grid-template-columns:repeat(2,1fr) !important;}
    ...
    .gform-embed iframe{height:1100px;}
...
<header class="nav">
  <div class="nav-inner">
    ...
    <a class="btn btn-gold nav-cta" href="#contact">Book Consultation</a>
...
<section class="hero" id="top">
  <div class="wrap hero-inner">
    <div>
      ...
      <div class="hero-ctas">
        <a class="btn btn-gold" href="#contact">Book Consultation</a>
...
<section id="about">
  <div class="wrap about-grid">
    ...
    <div class="about-body">
      ...
      <p>This business was started by my father, <strong>Ramkishor Prajapati</strong>, 20 years ago. He began by filing income tax returns and distributing mutual funds, and over the years expanded into a full range of other financial products and services. Today, I carry that legacy forward.</p>
      <p>I help individuals and families build wealth through disciplined financial planning and investment strategies. I am a registered financial advisor, having completed the <strong>NISM Investment Adviser Level 1 and Level 2 certifications</strong>, along with certifications in <strong>mutual fund distribution</strong>, <strong>portfolio management services</strong>, and <strong>derivatives across currency, interest rate, and equity segments</strong>.</p>
      ...
      <div class="facts-strip" style="grid-template-columns:repeat(4,1fr);">
        <div>
          <div class="fact-num">20+ Yrs</div>
          <div class="fact-label">Family legacy, founded by Ramkishor Prajapati</div>
        </div>
        <div>
        ...
        <div>
          <div class="fact-num">Derivatives</div>
          <div class="fact-label">Certified in currency, interest rate &amp; equity derivatives</div>
        </div>
      </div>
    </div>
  </div>
...
<section id="offerings" style="background:#fff;border-top:1px solid var(--line);">
  <div class="wrap">
    <div class="section-head reveal">
      <p class="eyebrow">What We Offer</p>
      <h2>A closer look at how we work with your money</h2>
    </div>

    <div class="offer-block">
      <h3>Core Investment Services</h3>
      <div class="offer-grid reveal">
        <div class="insight-card">
          <h3>Portfolio Management</h3>
          <p>Building and customizing your asset allocation to match your goals and risk profile.</p>
        </div>
        <div class="insight-card">
          <h3>Investment Research</h3>
          <p>Ongoing evaluation of stocks, bonds, and mutual funds before they earn a place in your portfolio.</p>
        </div>
        <div class="insight-card">
          <h3>Regular Rebalancing</h3>
          <p>Keeping your portfolio's risk level aligned with your targets as markets move.</p>
        </div>
        <div class="insight-card">
          <h3>Performance Reporting</h3>
          <p>Transparent, benchmark-based reporting so you always know how your investments are actually doing.</p>
        </div>
      </div>
    </div>
    ...
    <div class="offer-block">
      ...
      <div class="offer-grid reveal">
        <div class="insight-card">
          <h3>Retirement Planning</h3>
          <p>Estimating what you'll need and structuring income sources for after you stop working.</p>
        </div>
        <div class="insight-card">
          <h3>Tax Optimization</h3>
          <p>Reducing capital gains and overall tax liability through smarter investment structuring.</p>
        </div>
        <div class="insight-card">
          <h3>Estate Planning</h3>
          <p>Helping plan how your wealth transfers to your heirs, safely and with less friction.</p>
        </div>
        <div class="insight-card">
          <h3>Risk Management</h3>
          <p>Assessing your insurance needs so what you've built stays protected.</p>
        </div>
      </div>
    </div>

    <div class="offer-block">
      <h3>Goal-Based Planning Sequence</h3>
      <div class="mini-steps reveal">
        <div class="mini-step">
          <div class="mini-step-num">01</div>
          <h4>Discovery</h4>
          <p>Defining your short and long-term milestones.</p>
        </div>
        <div class="mini-step">
          <div class="mini-step-num">02</div>
          <h4>Analysis</h4>
          <p>Assessing your current net worth and cash flow.</p>
        </div>
        <div class="mini-step">
          <div class="mini-step-num">03</div>
          <h4>Strategy</h4>
          <p>Mapping specific investments to each milestone.</p>
        </div>
        <div class="mini-step">
          <div class="mini-step-num">04</div>
          <h4>Execution</h4>
          <p>Deploying capital into the recommended financial instruments.</p>
        </div>
      </div>
    </div>
  ...
  <div class="wrap contact-grid">
    ...
    <div>
      <div class="gform-embed">
        <iframe title="Consultation request form" src="https://docs.google.com/forms/d/e/1FAIpQLSeqbTeSTqoJewCjRVJSkC56uBTzrwtXM_jxiohOCmVQsrig4Q/viewform?embedded=true" loading="lazy">Loading form…</iframe>
      </div>
      <p class="form-note">Prefer email instead? Write to <a href="mailto:hrashprajapati99@gmail.com">hrashprajapati99@gmail.com</a>.</p>
    </div>
  </div>
</section>
  ...
  <div class="wrap">
    <div class="footer-grid">
      <div>
        ...
        <p class="footer-tagline">A family legacy since founded by Ramkishor Prajapati — personalized financial planning in Sagar, Madhya Pradesh.</p>
      </div>
    ...
    <p class="disclaimer">
      <strong>Mutual Fund investments are subject to market risks.</strong> Please read all scheme related documents carefully before investing. Past performance is not indicative of future returns. Harsh Prajapati is a registered financial advisor holding NISM Investment Adviser Level 1 &amp; 2 certifications, along with certifications in mutual fund distribution, portfolio management services, and derivatives across currency, interest rate, and equity segments (registration details available on request). This website does not constitute investment advice; please consult before making any investment decision based on your individual financial situation. Calculator results are indicative estimates only.
    </p>
